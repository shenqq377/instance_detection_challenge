# Invert background to white in a single path.
...
def get_args():
    ...
    args.datadir = "/root/database/objects_downsize/079_polaroid_film"
    args.destdir = "/root/database/objects_bk/079_polaroid_film"
